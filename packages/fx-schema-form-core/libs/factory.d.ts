...
export declare const schemaKeyWordFactory: BaseFactory<($id: string, schema: JSONSchema6, ajv: Ajv) => JSONSchema6>;
...
export declare const convertKeys: ($id: string, schema: JSONSchema6, ajv: Ajv) => JSONSchema6;
