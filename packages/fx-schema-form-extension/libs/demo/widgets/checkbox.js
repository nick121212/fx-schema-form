...
export class AntdCheckboxWidget extends PureComponent {
    ...
    render() {
        const { getOptions, uiSchema, updateItemData, validate, getTitle, formItemMeta } = this.props, { readonly = false } = uiSchema || {}, metaOptions = formItemMeta ? formItemMeta.getIn(["options", "widget", "checkbox"]) || fromJS({}) : fromJS({}), widgetOptions = getOptions(this.props, "widget", "checkbox", metaOptions);
