    ...
    var hoc = (0, _recompose.compose)((0, _recompose.withHandlers)({
        ...
        switchItem: function switchItem(propsCur) {
            return function (parentKeys, keys, curIndex, toIndex) {
                _reducer.schemaFormReducer.actions.switchItem({
                    parentKeys: parentKeys,
                    keys: keys,
                    curIndex: curIndex,
                    toIndex: toIndex
...
var SchemaFormReducer = exports.SchemaFormReducer = function () {
    function SchemaFormReducer(initialState) {
        ...
        this.switchItem = (0, _reduxAct.createAction)("元素22交换位置");
        ...
        var DataComponentHoc = function (_PureComponent) {
            ...
            _createClass(DataComponentHoc, [{
                ...
                value: function render() {
                    ...
                    var hoc = (0, _reactRedux.connect)(getItemDataHoc(this.props.parentKeys, keys));
...
var ObjectField = exports.ObjectField = function (_PureComponent) {
    ...
    _createClass(ObjectField, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_form.SchemaForm, { arrayIndex: arrayIndex, arrayLevel: arrayLevel, schemaId: uiSchema.schemaPath, uiSchemas: uiSchema.children || ["*"], uiSchema: uiSchema, parentKeys: parentKeys, globalOptions: globalOptions, ajv: ajv });
        }
    }]);
...
var ArrayField = exports.ArrayField = function (_PureComponent) {
    ...
    _createClass(ArrayField, [{
        ...
        value: function renderItem(idx) {
            ...
            return _react2.default.createElement(_form.SchemaForm, { key: idx, arrayIndex: idx, uiSchema: uiSchema, ArrayItemComponent: ArrayItemComponent, arrayLevel: arrayLevel.concat([idx]), schemaId: uiSchema.schemaPath, uiSchemas: uiSchema.children || ["-"], parentKeys: parentKeys, globalOptions: globalOptions, ajv: ajv });
        }
    }, {
        key: "render",
        value: function render() {
            ...
            return _react2.default.createElement("div", { style: arrayFieldStyle }, child || null);
        }
    }]);
