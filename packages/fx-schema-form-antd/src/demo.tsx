...
//         <Row>
//             <Col>
//                 <SchemaForm schemaFormOptions={schemaFormOptions}
//                     schemaKey={"test"} schema={ajv.getSchema("test").schema} RootComponent={Form} uiSchema={uiSchema} globalOptions={globalOptions}>
...
//             <Col>
//                 <SchemaForm schemaFormOptions={schemaFormOptions}
//                     schemaKey={"test1"} schema={ajv.getSchema("test").schema} RootComponent={Form} uiSchema={uiSchema} globalOptions={globalOptions}>
//                     <Form.Item labelCol={{ xs: 6, offset: 12 }} wrapperCol={{ xs: 6, offset: 12 }}>
//                         <Button onClick={() => {
//                             reducer1.actions.validateAllField.bind(reducer1)();

//                             if (store.getState().test1.meta.data.isValid) {
//                                 alert("提交表单");
//                             }
