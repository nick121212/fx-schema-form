...
var ItemButtons = (function (_super) {
    ...
    ItemButtons.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement(Button, { style: { marginRight: 5 }, type: "primary", shape: "circle", icon: "plus", ghost: true, onClick: function () { _this.props.addItem(); } }),
            React.createElement(Button, { type: !isShow ? "dashed" : "primary", shape: "circle", icon: isShow ? "shrink" : "arrows-alt", onClick: function () { _this.props.toggleItem(); } })));
    };
    return ItemButtons;
}(React.PureComponent));
export { ItemButtons };
var ItemChildButtons = (function (_super) {
    ...
    ItemChildButtons.prototype.render = function () {
        ...
        return (React.createElement(Popover, { placement: "topLeft", title: null, content: (React.createElement("div", null,
                ...
                React.createElement(Button, { style: { marginRight: 5 }, ghost: false, type: "dashed", shape: "circle", icon: "packup", onClick: function () { switchItem(index, index - 1); } }),
                React.createElement(Button, { ghost: false, type: "dashed", shape: "circle", icon: "unfold", onClick: function () { switchItem(index, index + 1); } }))), trigger: "hover" },
