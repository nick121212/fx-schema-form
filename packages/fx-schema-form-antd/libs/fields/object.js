...
var ObjectField = (function (_super) {
    ...
    ObjectField.prototype.render = function () {
        ...
        return (React.createElement(SchemaForm, { arrayIndex: arrayIndex, schemaFormOptions: schemaFormOptions, getCurrentState: getCurrentState, schemaKey: schemaKey, arrayLevel: arrayLevel, schema: mergeSchema, parentKeys: mergeSchema.originKeys, RootComponent: getFieldOptions("object").root, uiSchema: uiSchema.items || ["*"], globalOptions: globalOptions }));
    };
    return ObjectField;
}(React.Component));
export { ObjectField };
