...
export var ArrayHoc = function (hocFactory, Component) {
    var ArrayComponentHoc = (function (_super) {
        ...
        ArrayComponentHoc.prototype.render = function () {
            ...
            if (type === "array") {
                return React.createElement(Component, __assign({}, this.props, { ItemButtons: ItemButtonsWithHoc ? function () { return React.createElement(ItemButtonsWithHoc, __assign({}, _this.props)); } : function () { return React.createElement("span", null); }, ItemChildButtons: ItemChildButtonsWithHoc ? ItemChildButtonsWithHoc : function () { return React.createElement("span", null); } }));
            }
