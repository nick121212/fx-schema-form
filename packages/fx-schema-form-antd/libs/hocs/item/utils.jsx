...
export var UtilsHoc = function (hocFactory, Component) {
    var ComponentHoc = (function (_super) {
        ...
        ComponentHoc.prototype.render = function () {
            return <Component getHocOptions={this.getHocOptions.bind(this)} getFieldOptions={this.getFieldOptions.bind(this)} getWidgetOptions={this.getFieldOptions.bind(this)} {...this.props}/>;
        };
